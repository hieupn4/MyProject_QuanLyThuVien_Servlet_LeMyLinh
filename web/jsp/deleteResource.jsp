...
<p class="left"><img src="images/dot_o.gif" width="5" height="5" alt="" border="0">&nbsp;&nbsp;<a href="deletePatron.jsp">Cập nhật bạn đọc </a></p>
...
<table width="95%" border="0">
  ...
  <tr>
    ...
    <td><input name="delete.resourceID" type="text" id="delete.resourceID" size="35" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
