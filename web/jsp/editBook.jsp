    ...
    <form name="formEditBook" action="controler" method="get">
      <table width="95%" border="0" align="center">
        <tr>
          ...
          <td width="45%"><input name="book.id" type="text" id="book.id" size="35" value="<%=book.getID() %>" /></td>
          <td width="16%">&nbsp;</td>
        </tr>
        <tr>
          <td><p><strong>Tên sách : </strong></p></td>
          <td><input name="book.name" type="text" id="book.name" size="35" value="<%=book.getName() %>" /></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td><p><strong>Thuộc lĩnh vực : </strong></p></td>
          <td><input name="book.domain" type="text" id="book.domain" size="35" value="<%=book.getDomain() %>" /></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td><p><strong>Tác giả : </strong></p></td>
          <td><input name="book.authors" type="text" id="book.authors" size="35" value="<%=book.getAuthors() %>" /></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td><p><strong>Nhà xuất bản : </strong></p></td>
          <td><input name="book.publisher" type="text" id="book.publisher" size="35" value="<%=book.getPublisher() %>" /></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td><p><strong>Năm xuất bản : </strong></p></td>
          <td><input name="book.publishYear" type="text" id="book.publishYear" size="35" value="<%=book.getPulishYear() %>" /></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td><p><strong>Số lượng trong thư viện : </strong></p></td>
          <td><input name="book.amount" type="text" id="book.amount" size="35" value="<%=book.getAmount() %>" /></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td valign="top"><p><strong>Miêu tả về cuốn sách : </strong></p></td>
          <td><textarea name="book.description" id="book.description" cols="35" rows="5"><%=book.getDescription() %></textarea></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td><div align="center">
            ...
            <input name="book.submit" type="submit" id="book.submit" value="Save" />
