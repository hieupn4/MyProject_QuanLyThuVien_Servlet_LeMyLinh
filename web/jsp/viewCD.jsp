    ...
    <div>
      ...
      <table width="95%" border="0" align="center">
        <tr>
          ...
          <td width="59%"><p>CD_002</p></td>
          <td width="2%">&nbsp;</td>
        </tr>
        <tr>
          <td><p><strong>Tên CD : </strong></p></td>
          <td><p>Java software</p></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><p>Sun Microsoft system</p></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="30"><p><strong>Số lượng trong thư viện : </strong></p></td>
          <td><p>2</p></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          ...
          <td>
          	<p>
            	Tập các phần mềm cần thiết cho java programmer
            </p>
          </td>
          <td>&nbsp;</td>
        </tr>
