...
<p class="left"><img src="images/dot_o.gif" width="5" height="5" alt="" border="0">&nbsp;&nbsp;<a href="">Tìm tài liệu </a></p>
...
<p class="left"><img src="images/dot_o.gif" width="5" height="5" alt="" border="0">&nbsp;&nbsp;<a href="updatePatron.jsp">Tìm bạn đọc </a></p>
...
<form name="formCheckOut" method="get" action="controler">
  <table width="95%" border="0" align="center">
    ...
    <tr>
      <td><p>Tên đăng nhập của người mượn: </p></td>
      <td><input name="checkOut.userName" type="text" id="checkOut.userName" size="35"></td>
    </tr>
    <tr>
      <td><p>Mã của cuốn sách mượn : </p></td>
      <td><input name="checkOut.resourceID" type="text" id="checkOut.resourceID" size="35"></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><div align="center">
        <input name="action" type="hidden" value="CHECK_OUT"  />
        <input name="checkOut.submit" type="submit" id="checkOut.submit">
