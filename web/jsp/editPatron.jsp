...
<%
	...
	System.out.println("editPatron : " + patron.getUserName());
...
<link rel="alternate stylesheet" type="text/css" media="all" href="jscalendar/calendar-system.css" title="system" />
	...
	<script type="text/javascript" >
		...
		function patron_change(targ,selObj,restore){ //v3.0
...
<body leftmargin=0 topmargin=0 marginheight="0" marginwidth="0" bgcolor="#ffffff" onLoad="patron_type();">
...
<form name="formEditPatron" method="post" action="controler">
  <table width="95%" border="0" align="center">
    <tr>
      <td width="29%"><p><strong>Tên đăng nhập : </strong></p></td>
      <td width="71%"><input name="patron.userName" type="text" id="patron.userName" size="35" value="<%= patron.getUserName() %>" /></td>
    </tr>
    <tr>
      <td><p><strong>Mật khẩu : </strong></p></td>
      <td><input name="patron.password" type="text" id="patron.password" size="35" value="<%= patron.getPassword() %>" /></td>
    </tr>
    <tr>
      <td><p><strong>Họ tên : </strong></p></td>
      <td><input name="patron.fullName" type="text" id="patron.fullName" size="35" value="<%= patron.getFullName() %>" /></td>
    </tr>
    <tr>
      <td><p><strong>Ngày sinh : </strong></p></td>
      <td><input name="patron.birthday" type="text" id="patron.birthday" size="35" value="<%=date %>" /></td>
    </tr>
    <tr>
      <td><p><strong>e - Mail : </strong></p></td>
      <td><input name="patron.email" type="text" id="patron.email" size="35" value="<%=patron.getEmail() %>" /></td>
    </tr>
    <tr>
      <td><p><strong>Địa chỉ : </strong></p></td>
      <td><input name="patron.address" type="text" id="patron.address" size="35" value="<%=patron.getAddress() %>" /></td>
    </tr>
    <tr>
      <td height="30"><p><strong>Chức vụ : </strong></p></td>
      <td>
      <select name="patron.roles" id="patron.roles" onchange="patron_change('parent',this,0);">
  ...
  <div id="patron_student">
  	<table width="95%" border="0" align="center">
	  <tr>
	    <td width="29%"><p><strong>Mã sinh viên : </strong></p></td>
	    <td width="71%"><input name="student.id" type="text" id="student.id" size="35" value="<%=student.getStudentID()%>" /></td>
	  </tr>
	  <tr>
	    <td><p><strong>Lớp : </strong></p></td>
	    <td><input name="student.classrom" type="text" id="student.classrom" size="35" value="<%=student.getClassrom()%>" /></td>
	  </tr>
	  <tr>
	    <td><p><strong>Khoa : </strong></p></td>
	    <td><input name="student.department" type="text" id="student.department" size="35" value="<%=student.getDepartment()%>" /></td>
	  </tr>
	</table>
  </div>
  <div id="patron_faculty">
    <table width="95%" border="0" align="center">
	  <tr>
	    <td width="29%"><p><strong>Khoa : </strong></p></td>
	    <td width="71%"><input name="faculty.department" type="text" id="faculty.department" size="35" value="<%=faculty.getDepartment()%>" /></td>
	  </tr>
	  <tr>
	    <td><p><strong>Môn dạy : </strong></p></td>
	    <td><input name="department.subjects" type="text" id="faculty.subjects" size="35" value="<%=faculty.getSubjects()%>" /></td>
	  </tr>
	</table>
  </div>
  <div id="patron_libManager">
  	<table width="95%" border="0" align="center">
	  <tr>
	    <td width="29%"><p><strong>Chức năng : </strong></p></td>
	    <td width="71%"><input name="libManager.permission" type="text" id="libManager.permission" size="35" value="<%=libManager.getPermission()%>" /></td>
	  </tr>
	</table>
  </div>
  <div id="fuction">
	  ...
	  <tr>
	    ...
	    <td width="53%"><div align="center">
	      ...
	      <input name="patron.submit" type="submit" id="patron.submit" value="Save" />
	      <input name="patron.reset" type="reset" id="patron.reset" />
	    </div></td>
	    <td width="17%">&nbsp;</td>
	  </tr>
	  <tr>
...
<tr>
	<td width="300"><p class="menu02">Copyright &copy;2003 CompanyName.com</p></td>
	<td>
<p class="menu02">
<a href="">Home</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
<a href="">About Us</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
