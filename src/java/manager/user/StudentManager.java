...
public class StudentManager extends AbstractUserManager {
	...
	public List<Patron> gets() {
		...
		try{
			...
			while(resultSet.next()){
				...
				student.setUserName(resultSet.getString(PATRON_USER_NAME));
				student.setPassword(resultSet.getString(PATRON_PASSWORD));
				...
				student.setFullName(resultSet.getString(PATRON_FULL_NAME));
	...
	public boolean remove(String userName) {
		...
		return super.delete(userName);//SqlExecute.executeUpdate(sql);
	}
	...
	public boolean update(Patron patron) {
		...
		*/
		...
		String sql1 = "UPDATE " + STUDENT_TABLE_NAME + " SET " +
			...
			" WHERE "+ PATRON_USER_NAME + "='"+student.getUserName()+"';";
