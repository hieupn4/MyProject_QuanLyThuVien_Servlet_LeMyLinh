	...
	public List<Patron> gets() {
		...
		try{
			...
			while(resultSet.next()){
				...
				faculty.setUserName(resultSet.getString(PATRON_USER_NAME));
				faculty.setPassword(resultSet.getString(PATRON_PASSWORD));
				...
				faculty.setFullName(resultSet.getString(PATRON_FULL_NAME));
	...
	public boolean update(Patron patron) {
		...
		*/
		...
		String sql1 = "UPDATE " + FACULTY_TABLE_NAME + " SET " +
			...
			" WHERE "+ PATRON_USER_NAME + "='"+faculty.getUserName()+"';";
